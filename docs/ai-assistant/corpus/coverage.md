...
| K11 | HA/MQTT/Z2M/Node-RED/cameras | Compose service index, maintenance/replication | Installer/operator | Q15,Q16 | Per-service prerequisites, host mounts, actual commands and restart boundaries |
