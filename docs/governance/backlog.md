...
| W-2 | Guest denial tests (all-scopes token): 403 on helpdesk, KB, presence, camera/Frigate, admin, settings, access-link routes; 403 on non-GET; 401 on expired and revoked; `?t=` redacted in access logs | UC-1, UC-5 | D12, D11 | ad-hoc | Code | 18+5+6+9 = 38 | 3 | **12.7** | proposed | — |
...
| W-3 | Implement guest denial contract R-GD ([SO-2026-09-23-r1](signoffs/SO-2026-09-23-r1.md) §3.2) | UC-5 | D12 | ad-hoc | Code | 10+8+6+8 = 32 | 3 | **10.7** | proposed | W-2 |
...
|---|---|---|---|---|
| S6-1 | CANDIDATE persistence and D10 provenance (PR #93) | UC-3 | Code handover r8, Sprint 6 WSJF #1 | in review — conditions in [SO-2026-09-23-r1](signoffs/SO-2026-09-23-r1.md) §3.1 |
