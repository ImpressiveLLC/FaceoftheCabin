...
class BlinkMotionWebhookControllerTest {
    ...
    void refusesWithServiceUnavailableWhenNoApiKeyIsConfigured() {
        ...
        ResponseEntity<?> response = controller.trigger(
            new BlinkMotionWebhookController.WebhookRequest("home_aldrich_front"), requestWithHeader("anything"));
    ...
    void rejectsAMissingApiKeyHeader() {
        ...
        ResponseEntity<?> response = controller.trigger(
            new BlinkMotionWebhookController.WebhookRequest("home_aldrich_front"), requestWithHeader(null));
    ...
    void rejectsAWrongApiKeyHeader() {
        ...
        ResponseEntity<?> response = controller.trigger(
            new BlinkMotionWebhookController.WebhookRequest("home_aldrich_front"), requestWithHeader("wrong"));
    ...
    @Test
    void rejectsAMissingCameraField() {
        ReflectionTestUtils.setField(controller, "apiKey", "secret123");

        ResponseEntity<?> response = controller.trigger(
            new BlinkMotionWebhookController.WebhookRequest(null), requestWithHeader("secret123"));
    ...
    void rejectsACameraNotInTheBlinkCameraMap() {
        ...
        ResponseEntity<?> response = controller.trigger(
            new BlinkMotionWebhookController.WebhookRequest("not_a_real_camera"), requestWithHeader("secret123"));
    ...
    @Test
    void startsLiveviewForAKnownCameraWithACorrectKey() {
        ReflectionTestUtils.setField(controller, "apiKey", "secret123");
        ...
        ResponseEntity<?> response = controller.trigger(
            new BlinkMotionWebhookController.WebhookRequest("home_aldrich_front"), requestWithHeader("secret123"));
